export default {
	...
	skills: {
		...
		subtitle: "Lo que usé y uso en el día a día.",
		...
		items: {
			...
			backend: ["Node.js", "Express.js", "APIs REST", "Firebase", "PHP", "Java", "C#"],
			data: [
				"MySQL",
				"MS SQL Server",
				"SAP HANA / BW",
