export default {
	en: {
		message: {
			hello: "Hello, I'm Diego",
			subtitle:
				"Full Stack Web Developer - BI Analyst - Mechanical Engineering",
			aboutMeTitle: "About Me",
			experience: "Professional Experience",
			education: "Education",
			skillsSectionTitle: "Skills & Technologies",
			projectsSectionTitle: "Projects",
			projectsSectionTitlePage: "Some of my Projects",
			contact: "Contact",
			download_cv: "CV",
			aboutMe:
			...
			educationInstitution4: "UTN FRBA",
			educationDegree4: "Electronic Engineering",
			educationYears4: "2011 - 2013",
			educationInstitution5: "ORT Yatay",
			educationDegree5: "High School - Electronic",
			educationYears5: "2005 - 2010",
	...
	es: {
		message: {
			...
			subtitle: "Desarrollador Web Full Stack - BI Analyst - Ing. Mecánica",
			...
			download_cv: "CV",
			aboutMe:
				"La pandemia me ayudó a decidir hacer un cambio en mi carrera y vi a la programación como una gran oportunidad para desarrollarme profesionalmente. Soy una persona responsable, diligente y con gran capacidad para trabajar en equipo. Estoy en busca de un puesto que me brinde nuevos conocimientos y me permita crecer en este apasionante rubro.",
			...
			// Education Section
			educationInstitution1: "ORT Yatay",
			educationDegree1: "Analista de Sistemas",
			educationYears1: "2022 - Presente",
			educationInstitution2: "Digital House",
			educationDegree2: "Desarrollo Web FullStack",
			educationYears2: "2021 - 2022",
			educationInstitution3: "UTN FRBA",
			educationDegree3: "Ingeniería Mecánica",
			educationYears3: "2014 - 2021",
			educationInstitution4: "UTN FRBA",
			educationDegree4: "Ingeniería Electrónica",
			educationYears4: "2011 - 2013",
			educationInstitution5: "ORT Yatay",
			educationDegree5: "Secundario - Electrónica",
			educationYears5: "2005 - 2010",
